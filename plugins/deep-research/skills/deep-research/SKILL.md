...
---
## ⚠️ DATE-AWARE QUERY GENERATION (CRITICAL)

**All search queries MUST include current date context for freshness.**

### Get Today's Date First
Before generating ANY search query, determine today's date:
- Use system date or ask: "What is today's date?"
...
1. **Always append year to queries:**
   ...
   - ✅ "AI code assistants market 2026"
   - ✅ "AI code assistants trends January 2026"
...
Examples:
- "LLM agents 2026 latest developments"
- "AI healthcare 2026 market size"
- "테슬라 2026년 1월 최신 뉴스"
```
---
